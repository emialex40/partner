...
(function($) {
  $.fn.adGallery = function(options) {
    var defaults = { loader_image: 'loader.gif',
                     ...
                     animation_speed: 400,//скорость анимации
                     width: false,
                     height: false,
                     display_next_and_prev: true,//показ кнопок вперед/назад 
                     display_back_and_forward: true,//показ кнопок прокрутки карусели миниатюр
                     ...
                     effect: 'slide-hori', // // эффекты слайд-шоу: 'slide-vert', 'fade', or 'resize', 'none', false
