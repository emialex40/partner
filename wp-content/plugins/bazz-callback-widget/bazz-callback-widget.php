...
define( 'BAZZ_WIDGET_VERSION', '3.2' );
...
function bazz_layout() { ?>
	...
	<style>
		.bazz-widget {bottom: <?php echo($bazz_options_arr['bottom']); ?>px; <?php echo($bazz_options_arr['left_right']); ?>: 75px;}
	...
	<div class="bazz-widget">
		...
		<div class="bazz-widget-form">
			<div class="bazz-widget-form-top">
				<label>
					<?php _e('We will call back ','bazz-callback-widget');?> 
					<a href="javascript:void(0);" class="bazz-widget-your-name"> <?php _e('you','bazz-callback-widget');?></a> 
					<?php if ($bazz_options_arr['time'] == 0)  { ?>
						<?php _e('in the nearest future!','bazz-callback-widget');?>
					<?php } else { ?>
						<?php _e('in','bazz-callback-widget');?><br>00:<span class="bazz_time"><?php echo($bazz_options_arr['time']); ?></span> 
